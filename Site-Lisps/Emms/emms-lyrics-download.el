...
(defvar emms-lyrics-directory nil "default emms lyrics directory")
...
(defun emms-lyrics-redownload-lyric (&optional idx)
  "Interactively redownload lyrics for current playing. A prefix can be taken to specify which lyrics to download if there is multiple. (idx starts from 1)"
  (interactive "P")
  (let* ((track (emms-playlist-current-selected-track))
