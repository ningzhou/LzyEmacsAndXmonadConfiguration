...
(defface org-document-title
  '((((class color) (background light)) (:foreground "midnight blue" :weight normal :height 1.44))
    (((class color) (background dark)) (:foreground "pale turquoise" :weight normal :height 1.44))
    (t (:weight normal :height 1.44)))
