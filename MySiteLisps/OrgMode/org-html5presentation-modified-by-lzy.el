;;; org-html5presentation-modified-by-lzy.el --- HTML5 Presentation export for Org-mode
...
;; Modified by zhengyu li (lizhengyu419@gmail.com) at 2012-11-05
  ...
  (save-match-data
    (let* ((filename path)
      ...
      (if (and
        ...
        (if (string-match "\\.mp3$\\|\\.ogg$\\|\\.wav$\\|\\.wma$\\|\\.aac$" thefile)
            (concat "<audio id=\"audio-column\" src=\"" thefile "\" controls>"
                    (org-export-html5presentation-format-desc desc)
                    "</audio>")
          (if (string-match "\\.webm$\\|\\.mp4$\\|\\.mkv$\\|\\.rmvb$\\|\\.flv$\\|\\.avi$" thefile)
              (concat "<video id=\"video-column\" src=\"" thefile "\" controls>"
                      (org-export-html5presentation-format-desc desc)
                      "</video>")
            (concat
...
PUB-DIR is set, use this as the publishing directory."
  ...
  (let* ((opt-plist
    ...
    (cond
     ...
     (date)
     (t (setq date (format-time-string "%Y-%m-%d"))))
...
/*	font-family: GG240;*/
    ...
    -webkit-box-shadow: rgba(0, 0, 128, 0.28) 2px 2px 9px;
    -moz-box-shadow: rgba(0, 0, 128, 0.28) 2px 2px 9px;
    -o-box-shadow: rgba(0, 0, 128, 0.28) 2px 2px 9px;
    box-shadow: rgba(10, 10, 10, 0.5) 5px 4px 10px;
      }
...
<div class=\"slide\">
  <section class=\"center intro\">
    ...
    <p style=\"margin-top:100px\">
      %s <span style=\"font-size:20px\">%s</span>
    </p>
  </section>
</div>" title author date)))
...
(provide 'org-html5presentation-modified-by-lzy)
