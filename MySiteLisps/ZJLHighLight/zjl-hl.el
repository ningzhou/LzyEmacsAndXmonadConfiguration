...
(defface zjl-hl-font-lock-logic-face
  '((((class color)
      (background dark))
  ...
  :group 'zjl-hl-faces)
(defvar zjl-hl-font-lock-logic-face 'zjl-hl-font-lock-logic-face
  "Font lock mode face for logic symbol.  Changing this directly
  affects only new buffers.")

(defface zjl-hl-font-lock-dot-face
  '((((class color)
      (background dark))
  ...
  "*Font lock mode face for brackets, e.g. '.', ':', etc."
  :group 'zjl-hl-faces)
(defvar zjl-hl-font-lock-dot-face 'zjl-hl-font-lock-dot-face
  "Font lock mode face for dot symbol.  Changing this directly
  affects only new buffers.")

(defface zjl-hl-font-lock-semicolon-face
  '((((class color)
      (background dark))
     (:foreground "cyan1" :weight bold))
    (((class color)
      (background light))
     (:foreground "firebrick3"))
    (t
  ...
  "*Font lock mode face for brackets, e.g. ',', ';', etc."
  :group 'zjl-hl-faces)
(defvar zjl-hl-font-lock-semicolon-face 'zjl-hl-font-lock-semicolon-face
  "Font lock mode face for semicolon symbol.  Changing this directly
  affects only new buffers.")

(defface zjl-hl-font-lock-arithmetic-face
  '((((class color)
      (background dark))
  ...
  "*Font lock mode face for brackets, e.g. '+', '-', etc."
  :group 'zjl-hl-faces)
(defvar zjl-hl-font-lock-arithmetic-face 'zjl-hl-font-lock-arithmetic-face
  "Font lock mode face for arithmetic symbol.  Changing this directly
  affects only new buffers.")

(defface zjl-hl-font-lock-assignment-face
  '((((class color)
      (background dark))
  ...
  "*Font lock mode face for brackets, e.g. '+', '-', etc."
  :group 'zjl-hl-faces)
(defvar zjl-hl-font-lock-assignment-face 'zjl-hl-font-lock-assignment-face
  "Font lock mode face for assignment symbol.  Changing this directly
  affects only new buffers.")

(defface zjl-hl-font-lock-compare-face
  '((((class color)
      (background dark))
     (:foreground "red2" :weight bold))
    (((class color)
      (background light))
     (:foreground "firebrick3"))
    (t
  ...
  "*Font lock mode face for brackets, e.g. '+', '-', etc."
  :group 'zjl-hl-faces)
(defvar zjl-hl-font-lock-compare-face 'zjl-hl-font-lock-compare-face
  "Font lock mode face for assignment symbol.  Changing this directly
  affects only new buffers.")

(defface zjl-hl-font-lock-parenthesis-face
  '((((class color)
      (background dark))
     (:foreground "firebrick3" :weight bold))
    (((class color)
  ...
  "*Font lock mode face for brackets, e.g. '(', ')', etc."
  :group 'zjl-hl-faces)
(defvar zjl-hl-font-lock-parenthesis-face 'zjl-hl-font-lock-parenthesis-face
  "Font lock mode face for parenthesis.  Changing this directly
  affects only new buffers.")

(defface zjl-hl-font-lock-square-bracket-face
  '((((class color)
      (background dark))
     (:foreground "firebrick3" :weight bold))
    (((class color)
  ...
  "*Font lock mode face for brackets, e.g. '[', ']', etc."
  :group 'zjl-hl-faces)
(defvar zjl-hl-font-lock-square-bracket-face 'zjl-hl-font-lock-square-bracket-face
...
(setq zjl-hl-logic-regexp
      (regexp-opt '("&" "^" "~" "|")))

(setq zjl-hl-dot-regexp
      (regexp-opt '("." ":")))

(setq zjl-hl-semicolon-regexp
      (regexp-opt '(";" ",")))

(setq zjl-hl-arithmetic-regexp
      (regexp-opt '("+" "-" "*" "/" "%")))

(setq zjl-hl-assignment-regexp
      (regexp-opt '(" = ")))

(setq zjl-hl-compare-regexp
      (regexp-opt '("==" "<" ">" "!=" "<=" ">=")))

(setq zjl-hl-brackets-regexp
      (regexp-opt '("{" "}")))

(setq zjl-hl-parenthesis-regexp
      (regexp-opt '("(" ")")))

(setq zjl-hl-square-bracket-regexp
      (regexp-opt '("[" "]")))

(setq zjl-hl-types-regexp
      (concat
       "\\_<[_a-zA-Z][_a-zA-Z0-9]*_t\\_>" "\\|"       
       (concat "\\_<" (regexp-opt '("unsigned" "int" "char" "float" "void" "UINT8" "UINT16" "UINT32" "u_int8_t" "u_int16_t" "u_int32_t") 'words) "\\_>")))
...
(setq zjl-hl-c-mode-keywords (list
                              ...
                              (cons zjl-hl-logic-regexp (cons 0  '(zjl-hl-font-lock-logic-face keep)))
                              (cons zjl-hl-dot-regexp (cons 0  '(zjl-hl-font-lock-dot-face keep)))
                              (cons zjl-hl-semicolon-regexp (cons 0  '(zjl-hl-font-lock-semicolon-face keep)))
                              (cons zjl-hl-assignment-regexp (cons 0 '(zjl-hl-font-lock-assignment-face)))
                              (cons zjl-hl-compare-regexp (cons 0  '(zjl-hl-font-lock-compare-face keep)))
                              (cons zjl-hl-arithmetic-regexp (cons 0  '(zjl-hl-font-lock-arithmetic-face keep)))
                              (cons zjl-hl-brackets-regexp 'zjl-hl-font-lock-bracket-face)
                              (cons zjl-hl-parenthesis-regexp 'zjl-hl-font-lock-parenthesis-face)
                              (cons zjl-hl-square-bracket-regexp 'zjl-hl-font-lock-square-bracket-face)
