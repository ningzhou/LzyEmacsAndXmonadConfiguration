...
(defun my-color-theme ()
  ...
  (color-theme-install
   '(my-color-theme
     ...
     (diredp-file-name ((t (:foreground "Green3" :weight normal :height 1.10))))
     (diredp-file-suffix ((t (:foreground "deep pink" :height 1.0))))
     ...
     (font-lock-function-name-face ((t (:foreground "red2" :weight bold :height 1.0))))
     (font-lock-keyword-face ((t (:foreground "#00ffff" :weight normal :height 1.0))))
     ...
     (font-lock-string-face ((t (:foreground "red2" :weight normal :height 1.0))))
     (font-lock-type-face ((t (:foreground "green2" :weight normal :height 1.0))))
     (font-lock-variable-name-face ((t (:foreground "DeepPink" :weight normal :height 1.0))))
     ...
     (zjl-hl-font-lock-parenthesis-face ((t (:foreground "DodgerBlue1" :weight normal :height 1.15 :family "Monospace"))))
     ...
     (zjl-hl-function-call-face ((t (:foreground "#0088ff" :weight bold :height 1.0 :family "Monospace"))))
     ...
     (zjl-hl-number-face ((t (:foreground "white" :weight normal :height 1.0))))
