;; -*- Emacs-Lisp -*-
;;; LzyTheme.el ---
;; Time-stamp: <2013-03-31 04:28:04 Sunday by lzy>
...
(defun my-color-theme ()
  ...
  (color-theme-install
   '(my-color-theme
     ...
     (dired-directory ((t (:foreground "DeepSkyBlue2" :height 1.15))))
     (dired-flagged ((t (:foreground "red" :height 1.15))))
     (dired-header ((t (:foreground "red" :height 1.18))))
     (dired-ignored ((t (:foreground "white" :height 1.15))))
     (dired-mark ((t (:foreground "DeepPink" :height 1.155))))
     (dired-marked ((t (:foreground "yellow" :height 1.15))))
     (dired-perm-write ((t (:foreground "red" :height 1.15))))
     (dired-symlink ((t (:foreground "grey60"))))
     (dired-warning ((t (:foreground "gold" :height 1.15))))
     (dired-filetype-common ((t (:foreground "Peru"))))
     (dired-filetype-compress ((t (:foreground "DeepPink"))))
     (dired-filetype-document ((t (:foreground "gold"))))
     (dired-filetype-execute ((t (:foreground "RoyalBlue"))))
     (dired-filetype-image ((t (:foreground "MediumPurple"))))
     (dired-filetype-lnk ((t (:foreground "yellow"))))
     (dired-filetype-music ((t (:foreground "orange"))))
     (dired-filetype-omit ((t (:foreground "grey50"))))
     (dired-filetype-plain ((t (:foreground "springgreen"))))
     (dired-filetype-source ((t (:foreground "green"))))
     (dired-filetype-video ((t (:foreground "DeepPink"))))
     (dired-filetype-xml ((t (:foreground "Chocolate"))))
