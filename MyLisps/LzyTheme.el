;; -*- Emacs-Lisp -*-
;;; LzyTheme.el ---
;; Time-stamp: <2013-03-29 10:28:33 Friday by lzy>
  ...
  (color-theme-install
   '(my-color-theme
     ...
     ((apropos-match-face . match)
      ...
      (buffer-face-mode-face :family "Monospace" :height 1.05 :foreground "grey90" :weight normal)
     ...
     (apropos-function-button ((t (:foreground "Blue1"))))
     (apropos-keybinding ((t (:underline t))))
     (apropos-misc-button ((t (:foreground "dark cyan"))))
     (apropos-property ((t (:foreground "dark slate blue"))))
     (apropos-symbol ((t (:bold t :weight bold))))
     (apropos-variable-button ((t (:foreground "sienna"))))
     (bold ((t (:bold t :weight bold))))
     (bold-italic ((t (:italic t :bold t :slant italic :weight bold))))
     (border ((t (nil))))
     (buffer-menu-buffer ((t (:bold t :weight bold))))
     (button ((t (:underline t :foreground "RoyalBlue3"))))
     (c-annotation-face ((t (:foreground "dark cyan"))))
     (c-nonbreakable-space-face ((t (:bold t :weight bold :background "black" :foreground "white"))))
     ...
     (completions-common-part ((t (:family "DejaVu Sans Mono" :foundry "unknown" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "black" :background "white" :stipple nil :height 110))))
     ...
     (show-paren-match ((t (:background "SteelBlue1" :foreground "black"))))
